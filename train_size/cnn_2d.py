...
parser.add_argument('--input_dimension', default=[None,13,13,1])
...
train_x, train_y, test_x, test_y = preprocess_data.size_2d('shoe')
...
w5 = tensorflow.contrib.eager.Variable(tensorflow.truncated_normal((2048, flag.fc5_dimension), stddev=0.1), name='w5')
